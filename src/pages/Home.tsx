...
const Home = () => {
  return (
    ...
    >
      ...
      <motion.section 
        className="py-16 bg-primary overflow-hidden"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
        variants={staggerContainer}
        ...
        <div className="container mx-auto px-4">
          ...
          >
            {[
              ...
              >
                <motion.div 
                  className="bg-accent text-accent-foreground p-3 rounded-full w-12 h-12 flex items-center justify-center mb-4"
        ...
        <div className="container mx-auto px-4">
          ...
          >
            {[
              ...
              >
                <motion.div 
                  className={`bg-gradient-to-br ${item.gradient} text-white p-6 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-6 shadow-lg`}
                  whileHover={{ rotate: 360 }}
                  transition={{ duration: 0.6 }}
                >
      ...
      >
        <div className="container mx-auto px-4">
          ...
          >
            {[
              { step: "1", title: "Get Quote", description: "Contact us with your requirements and get an instant quote" },
              { step: "2", title: "Place Order", description: "Confirm your order and make payment through our secure system" },
              { step: "3", title: "Production", description: "We manufacture your products using the highest quality materials" },
              { step: "4", title: "Delivery", description: "Fast and reliable delivery to your construction site" }
            ].map((item, index) => (
              <motion.div 
                key={item.step}
                className="text-center"
              ...
              >
                <motion.div 
                  className="bg-white p-6 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-6 shadow-lg"
          ...
          >
            {[
              ...
              <motion.div 
                ...
                className="bg-concrete-light p-8 rounded-lg shadow-md"
                variants={staggerItem}
                whileHover={{ 
                  y: -8,
                  boxShadow: "0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)"
              ...
              >
                ...
                <div className="flex items-center">
                  <motion.div 
                    className="bg-primary text-white p-2 rounded-full w-10 h-10 flex items-center justify-center mr-3"
